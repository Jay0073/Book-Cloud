        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Welcome to BookVerse, your premier destination for digital reading. 
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Discover the advantages that make BookVerse the preferred choice for digital reading.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-900 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-indigo-100 mb-8 max-w-2xl mx-auto">
            Join thousands of readers who have already discovered the joy of digital reading with BookVerse.
          </p>
          <button className="
            px-8 py-4
            bg-white dark:bg-gray-900
